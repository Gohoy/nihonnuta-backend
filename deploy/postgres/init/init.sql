-- Helper: auto-update update_time on row change
...
-- ============================================================
-- lyrics_suggestions (UGC edits / audio re-uploads)
-- ============================================================
...
CREATE INDEX idx_wordbooks_user_review ON user_wordbooks(user_id, next_review_date);
...
CREATE INDEX idx_grammarbooks_user_review ON user_grammar_books(user_id, next_review_date);

CREATE TRIGGER trg_grammar_books_update_time
BEFORE UPDATE ON user_grammar_books
FOR EACH ROW
EXECUTE FUNCTION set_update_time();
